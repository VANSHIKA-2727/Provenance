      ...
      <div className="hidden lg:flex lg:w-[45%] h-full bg-neutral-950 p-16 flex-col justify-between relative overflow-hidden border-r border-neutral-900">
        ...
        <div className="relative z-10 border-t border-neutral-800 pt-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2 p-2 bg-neutral-900 rounded-full border border-neutral-800">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-neutral-950 text-white rounded-lg shadow-md text-[13px] font-bold px-4 py-4 hover:bg-neutral-800 transition-colors uppercase tracking-widest cursor-pointer mt-4"
              >
